                ...
                <div className='title-container'>
                    ...
                    <div className='genesis-container'>
                        <div className='blog-text-container'>
                            ...
                            The inventor of the lyre, god of oratory, conductor of the souls of the dead to the lower world, and patron (father) of merchants and thieves.
                            </p>
                            <div className='blog-img'>
                                <img src={mercury}  alt="zodiac wheel"/>
                                <p>
                                    Mercury at The Huntington Library, 2024
                                </p>
                            </div>
                            <p>
                            As messenger, Mercury (mind and the sensory nerves) utilizes the electrical energy of thought and the subtle nerve fluids created by Father Jupiter, the giver of all good things.
                            In action he may do this positively and hence beneficially, or negatively and destructively. In any case Mercury stands for merchandise, wares or goods, utilized in commerce or exchange 
                            ...
                            <p>
                            The words Mercury and mind are derived from the same root. Our minds must have goods with which and through which to express.
                            </p>
                            <h2>
                                Mercury's Pose
                            </h2>
                            ...
                            pointed directly overhead, is crowned with a winged hat. In the left hand and grasped by a handle extending from the middle pole or wand, is the caduceus, resting against the forearm and in
                            ...
                            <div className='blog-img'>
                                <img src={mercurytwo}  alt="zodiac wheel"/>
                                <p>
                                    Mercury at The Huntington Library, 2024
                                </p>
                            </div>
                            ...
                            The reader will note that the arm is forced backward and away from the body, instead, an unnatural and awkward position.
                            This was planned as a means of attracting one's attention to its relation to the back of Mercury, for the wand is the spine, 
                            and we hind this fact expressed in Hindu literature as the stick of Brahm. Brahmarandhra (Spirit or the Bee) enters the body through the Door of Brahm (suture in the skull) and leans on his stick. 
                            </p>
                            ...
                            <div className='blog-img'>
                                <img src={moses}  alt="zodiac wheel"/>
                                <p>
                            ...
                            the ages, begins now to blossom forth as a and wondrous story, and we realize at last that each individual has his own Tree of Life, 
                            his own Garden of Eden. No one but himself can destroy that tree. No one but himself can cultivate it or supply it with nutriment, so that 
                            in time it may bear twelve kinds of perfect fruit (the twelve divisions of the body). This process means THE OVER-COMING OF DEATH.
                            </p>
                            <p>
                            ...
                            However, how many physicians among them know of its immemorial metaphysical and physiological tradition? About as many as those having knowledge of the real interpretation of Freemasonry, of Astrology or Christianity.
                            </p>
                            <div className='quote'>
                                <p>
                            ...
                            {/* 
                            <p>
                                Seeing how God made our salvation in the 
                                image of our suffering, I think about Genesis 3:15. 
                            </p>
                            <div className='quote'>
                                <p>
                            ...
                            <p>
                                Crushing the snakes head as it strikes the heel of Adam. 
                                I interpret 
